...
List<CatListRes> catListResFromJson(String str) =>
    List<CatListRes>.from(json.decode(str).map((x) => CatListRes.fromJson(x)));

String catListResToJson(List<CatListRes> data) =>
